...
class LlavaQwenWithAlternatingAttnConfig(Qwen2Config):
    model_type = "llava_qwen_with_alternating_attn"


class LlavaQwenWithAlternatingAttnModel(LlavaMetaModel, Qwen2Model):
    config_class = LlavaQwenWithAlternatingAttnConfig
    ...
    def __init__(self, config: Qwen2Config):
        ...
        super(LlavaQwenWithAlternatingAttnModel, self).__init__(config)
...
class LlavaQwenWithAlternatingAttnForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaQwenWithAlternatingAttnConfig

    def __init__(self, config):
        # super(Qwen2ForCausalLM, self).__init__(config)
        Qwen2ForCausalLM.__init__(self, config)
        config.model_type = "llava_qwen_with_alternating_attn"
        config.rope_scaling = None

        self.model = LlavaQwenWithAlternatingAttnModel(config)
...
AutoConfig.register("llava_qwen_with_alternating_attn", LlavaQwenWithAlternatingAttnConfig)
AutoModelForCausalLM.register(LlavaQwenWithAlternatingAttnConfig, LlavaQwenWithAlternatingAttnForCausalLM)
